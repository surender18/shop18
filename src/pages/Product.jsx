    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="mt-20">
        <div className="flex">
          ...
          <p className='border px-5 py-3 text-sm'>Reviews(78)</p>
        </div>
          <div className="flex flex-col border gap-4 px-6 py-6 text-sm text-gray-500">
            <p>{productData.description}</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam consectetur exercitationem eum veniam culpa facilis, quas nesciunt? Ullam, fugiat vel.</p>
          </div>
      </div>
